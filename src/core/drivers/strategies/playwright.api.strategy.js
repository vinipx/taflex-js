...
export class PlaywrightApiStrategy extends AutomationDriver {
  ...
  /**
   * API navigation is implicit in request methods; this method is a no-op.
   */
  ...
  /**
   * UI-specific method not applicable to API strategies.
  ...
  /**
   * Loads locators for a specific feature.
